...
To note that only one NAT gateway is created in the demo. However, to avoid any single point of failure, having another NAT gateway in a different availability zone is recommended.
